...
void GeomGlut::initGraphicsWin( unsigned int pixelWinX, unsigned int pixelWinY, double _xMin, double _xMax, double _yMin, double _yMax,const vector<pair<string,long double> >& _goldValues,const vector<pair<string,long double> >& _goldInflations)
{
