...
class GeomGlut
{
  public:
    ...
    //--- Public methods ---
    void initGraphicsWin( unsigned int pixelWinX, unsigned int pixelWinY, double xMin, double xMax, double yMin, double yMax , long double r, long double sStraight, long double sAlong);
    ...
    long double getSpeedStraight() const {return speedStraight;}
    long double getSpeedAlong() const {return speedAlong;}
  private:
    //--- Private members ---
    coord2D minWin;
    coord2D maxWin;
