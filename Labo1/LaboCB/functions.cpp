...
/// Attention cas spécial, si le tableau ne contient que des zéros, renvoie 1 !
/// Gère le cas où le tableau est de taille 1 et avec un 0
...
bool* div(const bool b1[], const bool b2[], const int length)
{
	...
	{
		// Si le diviseur est plus grand que le numérateur,
		// alors on shift le numérateur pour qu'il soit plus grand
